...
Привет! <br>
Немного обо мне: я - начинающий frontend-разработчик. Обучался в GeekBrains GeekUniversity. Также закончил курс Front-End Development на Udemy. Выполнял различные лабораторные проекты с использованием основного стека технологий веб-разработки.
